                ...
                <div class="navbar-nav ms-auto py-0">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu dropdown-submenu">
                                    ...
                                    <li>
                                        <a class="dropdown-item icodalname" href="ra6426.html">Foreign Currency Deposit Act of the Philippines</a>
                                    </li>
                                    <li>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li>
                                <a class="dropdown-item" href="https://sc.judiciary.gov.ph/wp-content/uploads/2026/08/2026-BAR-Bar-Bulletin-No.-4.pdf">
                                    Bar Bulletin # 4
                                </a>
                            </li>
